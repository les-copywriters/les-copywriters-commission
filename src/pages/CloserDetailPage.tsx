...
import { mockSales, mockRefunds } from "@/data/mock";
...
const CloserDetailPage = () => {
  ...
  const sales = mockSales.filter(s => s.closer === decodedName);
  const totalComm = sales.reduce((a, s) => a + s.closerCommission, 0);
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Closer — {t("detail.performance")}</p>
          </div>
        </div>
